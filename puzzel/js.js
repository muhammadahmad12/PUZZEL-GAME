		...
		if (tileClicked == false) {
			...
			setTimeout(function () {
				if (
					...
					$("#piece-1").css("top") == "0px" &&
					$("#piece-2").css("left") == "340px" &&
					$("#piece-2").css("top") == "0px" &&
					$("#piece-3").css("left") == "680px" &&
					$("#piece-3").css("top") == "0px" &&
					$("#piece-4").css("left") == "0px" &&
					$("#piece-4").css("top") == "340px" &&
					$("#piece-5").css("left") == "340px" &&
					$("#piece-5").css("top") == "340px" &&
					$("#piece-6").css("left") == "680px" &&
					$("#piece-6").css("top") == "340px"
				) {
					$("p").text(
